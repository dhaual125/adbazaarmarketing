...
const team = [
  {
    ...
    bio: "5+ years in digital marketing and technology. Passionate about helping businesses scale. Believes the best growth comes from combining great technology with great marketing.",
    color: "var(--purple)",
  },
  {
    name: "Manish Nath",
