...
export const IntroLead: React.FC = () => {
  ...
  return (
    <section className="intro relative z-[2] px-7 md:px-14 pt-14 pb-4 mt-[-10vh]" ref={ref}>
      <div className="wrap max-w-[1176px] mx-auto">
        ...
        <p className={`mt-6 text-[clamp(15px,1.15vw,18px)] leading-[1.65] max-w-[58ch] text-[#4a4a4a] transition-all duration-700 delay-150 ease-out ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          From AI-powered websites and custom software to revenue-driving ads, influencer campaigns, and crisis account recovery — we provide the complete technology and marketing stack your business needs to dominate.
        </p>
      </div>
    </section>
  );
